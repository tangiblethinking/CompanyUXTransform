    ...
    <section id="phases" className="phases-section" ref={ref}>
      ...
      >
        {sheet && (
          <div>
            {sheet.description && (
              <div style={{ padding: '16px', borderRadius: 12, background: `${sheet.color}08`, border: `1px solid ${sheet.color}22`, marginBottom: 24 }}>
            ...
            {sheet.improvement && (
              <div style={{ padding: '16px 20px', borderRadius: 12, background: 'var(--ink)', marginTop: 20, display: 'flex', alignItems: 'center', gap: 12 }}>
