    ...
    <section id="hero" className="hero" ref={heroRef}>
      ...
      <div className="container hero-content">
        ...
        <p className="hero-sub">
          Applied behavioral psychology from UX standards across 3 company verticals (Website, Customer Portal, Back Office Tools) and transformed measurable business outcomes — all rooted in established behavorial science.
        </p>
